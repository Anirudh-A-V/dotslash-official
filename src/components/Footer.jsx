...
const Footer = () => {
	return (
		<div className='flex flex-col  w-full justify-start items-center mt-10'>
			{/* logo */}
			<p className={`text-[32px] font-normal text-white italic ${PPEditotialNewFont.className} mb-6`}>
				much more to come
			</p>
			<p className={`text-[18px] font-normal text-white ${PPNeueMontrealFont.className} mb-2`}>
				Want to sponsor us ?
			</p>
			<Link
				href="mailto:dotslashcet.cse@gmail.com"
				className={`text-[14px] font-medium text-white ${PPNeueMontrealFont.className} mb-14 bg-[#434A66] flex justify-center items-center p-2`}
			>
				Get in Touch
			</Link>
			<p className={`text-[14px] md:text-[16px] font-normal text-white ${PPNeueMontrealFont.className} mb-4`}>
			...
			<p className={`text-[14px] font-normal text-[#777777] ${PPNeueMontrealFont.className} mb-4`}>
