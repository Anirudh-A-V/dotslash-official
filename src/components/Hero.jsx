  ...
  return (
    <div className="flex relative justify-center items-center flex-col w-full h-screen">
      <div className="w-full lg:min-w-[768px] flex justify-center items-center flex-col">
        ...
        />
        <h2
          className={`text-white font-normal text-[12px] lg:text-[16px] leading-normal tracking-[0.6em] lg:tracking-[1em] px-1 ml-2 mt-4 ${PPNeueMachinaFont.className}`}
        >
      ...
      {/* <div className="absolute inset-0 w-full h-full flex justify-center items-center">
        <video
          className="-z-10 w-full h-1/3 lg:w-1/2 lg:h-1/2 object-cover"
          autoPlay
          muted
