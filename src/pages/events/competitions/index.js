...
import { getCompetitions, urlFor } from '@/utils/sanity';
...
const CompetitionsPage = () => {
    ...
    return (
        <>
            ...
            >
                <Navbar />
                <h1 className={`text-white text-4xl text-center font-medium mt-20 mb-8 ${PPNeueMontrealFont.className}`}>COMPETITIONS</h1>
                {
                    loading ? (
