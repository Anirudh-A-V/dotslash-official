...
import { getWorkshops, urlFor } from '@/utils/sanity';
...
const WorkshopsPage = () => {
    ...
    return (
        <>
            ...
            >
                <Navbar />
                <h1 className={`text-white text-4xl text-center font-medium mt-20 mb-8 ${PPNeueMontrealFont.className}`}>WORKSHOPS</h1>
                {
                    loading ? (
